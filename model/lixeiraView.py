...
class LixeiraView:
    ...
    def createLixeira(self):
        self.lixeiraModel = Lixeira(5,0,5, False)
        
        self.window.title("Lixeira - IP: " + str(self.lixeiraModel.getLatitude()))
        ...
        self.percentageLabel["text"] = "(" + str(self.lixeiraModel.getCapacidade()) + ")"
    ...
    def bindAddButton(self, event):
        return
        # if self.lixeiraModel.getBloqueado() or self.lixeiraModel.getPercentage() >= 1: self.addButton['state'] = 'disabled'
        # elif not self.lixeiraModel.getBloqueado() and self.lixeiraModel.getPercentage() < 1: self.addButton['state'] = 'normal'
